1. **cubes/*** : Hyperspectral data of AVIRIS Cuprite area, Nevada, during summer 1995. (the .hdr file is plain text header file, the data file is compressed to two segments)
